...
const translations = {
  'zh-CN': {
    ...
    rolePermissionsUpdated: '角色 "管理员" 的权限已更新',
  ...
  'zh-TW': {
    ...
    rolePermissionsUpdated: '角色 "管理員" 的權限已更新',
  ...
  'en': {
    ...
    rolePermissionsUpdated: 'Role "Administrator" permissions updated',
    ...
    reassignRole: 'Reassign Role',
    reassignGroup: 'Reassign Group',
